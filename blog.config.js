...
const BLOG = {
  ...
  GREETING_WORDS: process.env.NEXT_PUBLIC_GREETING_WORDS || 'Hi，Welcome to Damon\'s Blog',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Damon S.', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '莫听穿林打叶声，何妨吟啸且徐行', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://damons-blog.notion.site/main?source=copy_link', // 网站地址
